export default function AiAutomationServicesIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
      <g clipPath="url(#clip0_2005_360)">
        <path
          ...
          fill="url(#paint0_linear_2005_360)"
        />
      </g>
      <defs>
        <linearGradient id="paint0_linear_2005_360" x1="0" y1="20" x2="40" y2="20" gradientUnits="userSpaceOnUse">
          <stop stopColor="#A291FE" />
          <stop offset="0.5" stopColor="#5C57E7" />
          <stop offset="1" stopColor="#71BBF9" />
        </linearGradient>
